  ...
  return <>
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" style={{ background: '#FF8000' }}>
        <Toolbar>
          <Typography variant='h5' component="div" sx={{ flexGrow: 1 }}>Pizza-Home
          <LocalPizzaIcon sx={{ color: 'yellow', fontSize: 35 }} />
          </Typography>
          ...
          <Button component={NavLink} to='/menu1' style={({ isActive }) => { return { backgroundColor: isActive ? '#6d1b7b' : '' } }} sx={{ color: 'white', textTransform: 'none' }}>Order Now</Button> <br></br>
